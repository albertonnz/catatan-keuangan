<div class="container py-4">
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    <input type="text" wire:model="search" class="form-control" placeholder="Cari judul...">
                </div>

                <div class="col-md-4">
                    <select wire:model="filterJenis" class="form-control">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <button class="btn btn-info btn-sm"
                                        wire:click="$set('editFinanceId', {{ $finance->id }})"
                                        data-bs-toggle="modal"
                                        data-bs-target="#editFinanceCoverModal">
                                    Cover
                                </button>
